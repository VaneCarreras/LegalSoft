        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToPage("Usuario ingresó exitosamente.", new { email = Input.Email, returnUrl = returnUrl });
                    }
                    else
                    {
ModelState.AddModelError(string.Empty, "Debes confirmar tu cuenta. Se ha enviado el correo de confirmación.");
                return Page();
                    }
                }

    ...
    $.ajax({
        ...
        success: function (equipos) {
            ...
            $.each(equipos, function (index, equipo) {  
                ...
                contenidoTabla += `
                <tr>
                    <button type="button" class="btn btn-success btn-sm" onclick="AbrirModalEditar(${equipo.equipoID})">
                    <i class="fa-solid fa-marker"></i>
                    </button>
                    </td>
                    <td class="text-center">
                    <button type="button" class="btn btn-danger btn-sm" onclick="EliminarRegistro(${equipo.equipoID})">
...
function AbrirModalEditar(equipoID){
    ...
    $.ajax({
        ...
        success: function (equipos) {
            ...
            $("#ModalTitulo").text("Editar Equipo");
        },
